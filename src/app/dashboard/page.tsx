...
const mockBookings: Booking[] = [
    ...
    { id: 'b2', userId: 'u1', spaceId: 's2', eventId: 'e2', startTime: new Date('2024-08-20T19:00:00'), endTime: new Date('2024-08-20T22:00:00'), status: 'pending', totalCost: 0, spaceName: 'Rooftop Garden Oasis', eventTitle: 'Indie Film Screening', image: "https://placehold.co/100x101.png" },
];
